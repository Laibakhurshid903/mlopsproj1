...
#Load the updated live model to be made live
model = joblib.load("liveModelV1.pk1")
#Load the data to check accuracy
data = pd.read_csv('mobile_price_range_data (1).csv')
x = data.iloc[:, :-1]
y = data.iloc[:, -1] #Train test split for accuarcy calculation on only the testing data
...
#calculate accuracy \
>>>>>>> ec2d6043ef65dbc57c19891f4767b6426ee35f94
